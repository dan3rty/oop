...
// ну тут по тесту понятно, что править (исправлено)
TEST_CASE("rationals with sign in diff parts equals")
{
	CRational r1(8, -7);
	CRational r2(-8, 7);
...
TEST_CASE("numbers with sign in diff parts equals")
{
	CRational r1(8, -4);
	CRational r2(-8, 4);
	int n = -2;

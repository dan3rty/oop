...
{
	output << sportsman.lastName << " " << sportsman.firstName << " " << sportsman.patronymic << std::endl
		   << "Height: " << sportsman.height << std::endl
		   << "Weight: " << sportsman.weight << std::endl;
}
...
int main(int argc, char* argv[])
{
	...
	try
	{
		...
		std::cout << "[Tallest Sportsman]" << std::endl;
		PrintSportsman(std::cout, tallestSportsman);
		std::cout << std::endl 
			<< 
"[Heaviest Sportsman]" << std::endl;
